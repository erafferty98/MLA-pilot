...
#         - Goal: {user_goal} (e.g., "lose 10 pounds in 3 months")
#         - Fitness Level: {user_fitness_level} (e.g., "beginner")
#         - Available Time: {user_available_time} (e.g., "30 minutes per day")
#         - Preferred Days/Times: {user_workout_schedule} (e.g., "weekday evenings")
#         - Equipment: {user_preferences} (e.g., "has dumbbells and resistance bands")
